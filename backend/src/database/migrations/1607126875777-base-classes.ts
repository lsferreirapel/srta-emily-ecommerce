...
export default class BaseClasses1607126875777 implements MigrationInterface {
  name = 'baseClasses1607126875777';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "sizes" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "created_At" datetime NOT NULL DEFAULT (datetime('now')), "updated_At" datetime NOT NULL DEFAULT (datetime('now')), CONSTRAINT "UQ_9fc6e663546e7a6cfdc465e86df" UNIQUE ("name"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "colors" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "rgb" varchar NOT NULL, CONSTRAINT "UQ_7bb1e1980c83d685f0d3e9a24c6" UNIQUE ("name", "rgb"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "pictures" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "path" varchar NOT NULL, "created_At" datetime NOT NULL DEFAULT (datetime('now')), "updated_At" datetime NOT NULL DEFAULT (datetime('now')), "colorId" integer, "productId" integer, CONSTRAINT "UQ_0e33a1e77a98d730b6857aa0acd" UNIQUE ("path"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "products" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "name" varchar NOT NULL, "description" varchar NOT NULL, "brand" varchar NOT NULL, "price" integer NOT NULL, "interest" integer NOT NULL, "discount" integer NOT NULL, "freeShipping" boolean NOT NULL, "isNew" boolean NOT NULL, "rating" integer NOT NULL, "numberOfReviews" integer NOT NULL, "countInStock" integer NOT NULL, "created_At" datetime NOT NULL DEFAULT (datetime('now')), "updated_At" datetime NOT NULL DEFAULT (datetime('now')))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_pictures" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "path" varchar NOT NULL, "created_At" datetime NOT NULL DEFAULT (datetime('now')), "updated_At" datetime NOT NULL DEFAULT (datetime('now')), "colorId" integer, "productId" integer, CONSTRAINT "UQ_0e33a1e77a98d730b6857aa0acd" UNIQUE ("path"), CONSTRAINT "FK_8be9e742031e7e320e9a6c18aac" FOREIGN KEY ("colorId") REFERENCES "colors" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION, CONSTRAINT "FK_c81df1a7a2d02711a092d423cfc" FOREIGN KEY ("productId") REFERENCES "products" ("id") ON DELETE NO ACTION ON UPDATE NO ACTION)`,
    );
    await queryRunner.query(
